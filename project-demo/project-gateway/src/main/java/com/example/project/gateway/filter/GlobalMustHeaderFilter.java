...
import com.example.project.gateway.handler.factory.MustHeaderVerifyHandlerFactory;
 ...
 * 是否验证请求头
 */
@ConditionalOnProperty(prefix = "system.verify.must-header", name = "enabled", havingValue = "true", matchIfMissing = true)
@Component
